# AndroidCPP
Android and C++ Simple project. Repository shows how to bridge Kotlin and C++ code

## Project [C++ Source code](https://github.com/earljohn004/AndroidCPP/tree/master/app/src/main/cpp)
``` cpp 
#include <jni.h>
#include <string>
...
## Kotlin [Source Code](https://github.com/earljohn004/AndroidCPP/tree/master/app/src/main/java/com/tutorial/androidcpp)
```kotlin
